...
import { View, Text, StyleSheet, TouchableOpacity, Share, Alert, Linking, Image } from 'react-native';
...
const CustomerProfileScreen = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        console.log('CustomerProfile - User token from AsyncStorage:', userToken);
        
        if (userToken) {
          // Get user data from Firestore using the token as user ID
          const profile = await getUserProfile(userToken);
          console.log('CustomerProfile - User data from Firestore:', profile);
  ...
  return (
    <View style={styles.container}>
      {/* Keep the existing UnifiedHeader */}
      <UnifiedHeader
      ...
      />
        ...
        <View style={styles.profileSection}>
          ...
          <Text style={styles.profileName}>{fullName || t('profile.customer')}</Text>
        </View>
